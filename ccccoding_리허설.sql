...
(4, 'admin', 'admin@ccccoding.com', '관리자', '33275a8aa48ea918bd53a9181aa975f15ab0d0645398f5918a006d08675c1cb27d5c645dbd084eee56e675e25ba4019f2ecea37ca9e2995b49fcb12c096a032e', '2024-04-08 14:59:14', 100, '2024-05-21 13:23:51', NULL);
...
CREATE TABLE `coupons` (
  `cid` int NOT NULL,
  `coupon_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '쿠폰명',
  `coupon_desc` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '쿠폰설명',
  `coupon_image` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '쿠폰이미지',
  `coupon_type` varchar(10) COLLATE utf8mb4_general_ci NOT NULL COMMENT '할인종류',
  `coupon_price` double NOT NULL COMMENT '할인금액',
  `coupon_ratio` double NOT NULL COMMENT '할인비율',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '상태',
  `regdate` datetime NOT NULL COMMENT '등록일',
  `userid` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '등록한유저',
...
(103, '블랙프라이데이', '블랙프라이데이 최대 70% 쿠폰', '/ccccoding/admin/c_upload/20240502174614150905.jpg', '2', 0, 70, 2, '2024-05-02 17:46:14', '', 20000, 70000, '2', '2024-12-01', '2024-12-31');
...
CREATE TABLE `event` (
  `eid` int NOT NULL,
  `e_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `e_img` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `e_file` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `members` (
  `mid` int NOT NULL,
  `userid` varchar(145) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(245) COLLATE utf8mb4_general_ci NOT NULL,
  `username` varchar(145) COLLATE utf8mb4_general_ci NOT NULL,
...
(26, 'ccc01', 'ccc01@abc.com', 'ccc01', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', '2024-03-01 12:03:12', 19, NULL, '010-1111-1111', '/ccccoding/mypage/uploads/favi_logo.png', '10,000'),
(27, 'ccc02', 'ccc02@abc.co,', 'ccc02', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', '2024-05-01 12:03:29', 20, NULL, '010-2222-2222', NULL, '1,000'),
(28, 'ccc03', 'ccc03@abc.com', 'ccc03', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', '2024-05-21 12:04:59', 21, NULL, '010-3333-3333', NULL, NULL),
(29, 'ccc04', 'ccc04@abc.com', 'ccc04', 'd404559f602eab6fd602ac7680dacbfaadd13630335e951f097af3900e9de176b6db28512f2e000b9d04fba5133e8b1c6e8df59db3a8ab9d60be4b97cc9e81db', '2024-05-21 12:05:14', 22, '탈퇴', '010-4444-4444', NULL, NULL),
(30, 'ccc05', 'ccc05@abc.com', 'ccc05', 'cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e', '2024-05-21 12:06:24', 23, '휴먼', '010-5555-5555', NULL, NULL),
(31, 'ㅋㅋㅋ', 'dbdkdud98@naver.com', 'ㅋㅋㅋ', 'fb131bc57a477c8c9d068f1ee5622ac304195a77164ccc2d75d82dfe1a727ba8d674ed87f96143b2b416aacefb555e3045c356faa23e6d21de72b85822e39fdd', '2024-05-21 12:48:09', NULL, NULL, '01075226954', '/ccccoding/mypage/uploads/main_section_content1.png', NULL);
...
CREATE TABLE `payments` (
  ...
  `cancel_request` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `refund_request` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mid` int DEFAULT NULL,
  `pid` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
...
(35, '2024-05-21', NULL, NULL, NULL, NULL, 26, '31,32', 785350, 2),
(36, '2024-05-21', NULL, NULL, NULL, NULL, 26, '33', 19950, 2),
(39, '2024-05-21', NULL, NULL, NULL, NULL, 27, '33,34', 989930, 2),
(40, '2024-05-21', NULL, NULL, NULL, NULL, 27, '35', 19950, 0),
(41, '2024-05-21', NULL, NULL, NULL, NULL, 31, '36', 499850, 0);
...
CREATE TABLE `products` (
  ...
  `cnt` int DEFAULT NULL,
  `textbook` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
(33, 'PHP 프로그래밍 실무 완전 정복! with MySQL', 'A0003B0005', 'PHP와 MySQL을 사용하여 실제 웹 애플리케이션을 개발하는 강의입니다. 서버 사이드 프로그래밍, 데이터베이스 관리, 보안 등을 종합적으로 다루며, 실무 프로젝트를 통해 완성도 높은 웹 사이트를 제작합니다.', '/ccccoding/admin/upload/20240520093951822550.png', 500000, 1, 0, 0, 'PHP 실무', 150, 1, 1, 0, 0, 0, 'admin', '2024-08-01', '2024-09-01', '2024-05-20 16:39:51', 1, 0, '', 0, 0);
...
(1, 14, '관리자', '            가가가ㅏ', '2024-05-16 12:16:33'),
(3, 21, '관리자', '            답변', '2024-05-17 11:16:56'),
(4, 22, '관리자', '            다1변', '2024-05-17 11:18:55'),
(5, 19, '관리자', '            ㄱㄱㄱㄱ', '2024-05-21 11:29:49'),
(6, 23, '관리자', '            답변', '2024-05-21 12:38:47');
...
(24, 103, 'ccc01', 1, '2024-06-20 23:59:59', '2024-05-21 13:10:10', '블랙프라이데이');
...
--
ALTER TABLE `coupons`
  MODIFY `cid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `members`
  MODIFY `mid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- 테이블의 AUTO_INCREMENT `notice`
--
ALTER TABLE `notice`
  MODIFY `idx` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- 테이블의 AUTO_INCREMENT `payments`
--
ALTER TABLE `payments`
  MODIFY `oid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `user_coupons`
  MODIFY `ucid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
